...
class Ase_actividades_model extends CI_Model {
	
	public $nombre_tabla="asesoria_proyectos_actividades";
	...
	{
		$this->db->select("a.* ");
		$datos= $this->db->get_where($this->nombre_tabla." a",array('a.activo'=>1,'a.id_proyecto'=>$id))->result_array();
