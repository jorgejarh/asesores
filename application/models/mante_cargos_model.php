...
class Mante_cargos_model extends CI_Model {
	
	public $nombre_tabla="mante_cargos";
    ...
    function obtener($id=0)
	{
		if($id==0)
		{
			...
			return $this->db->order_by('nombre_cargo','ASC')->get_where($this->nombre_tabla,array('activo'=>1))->result_array();
		}else{
