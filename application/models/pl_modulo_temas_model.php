...
class Pl_modulo_temas_model extends CI_Model {
	
	public $nombre_tabla="pl_modulos_temas";
	...
	function lista($id=0)
	{
		...
		return $this->db->get_where($this->nombre_tabla." a",array('id_modulo'=>$id,'a.activo'=>1))->result_array();
