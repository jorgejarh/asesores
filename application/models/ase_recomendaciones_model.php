...
class Ase_recomendaciones_model extends CI_Model {
	
	public $nombre_tabla="asesoria_recomendaciones";
	...
	{
		$this->db->select("a.* ");
		$datos= $this->db->get_where($this->nombre_tabla." a",array('a.activo'=>1,'a.id_actividad'=>$id))->result_array();
		return $datos;		
	}
