...
class Mante_tipos_evaluacion extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_tipos_evaluacion";

	public $modelo_usar="mante_tipos_evaluacion_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_tipo_evaluacion","Nombre tipo Evaluacion",'required|xss_clean', 'text');
