...
class Mante_profesiones extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_profesiones";

	public $modelo_usar="mante_profesiones_model";

	public $nombre_controlador="mante_profesiones";
	
	public $nombre_titulo="Gestion de Profesiones";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_profesion","Profesion",'required|xss_clean');
