...
class Mante_tipos_facilitadores extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_tipos_facilitadores";

	public $modelo_usar="mante_tipos_facilitadores_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_tipo_facilitador","Tipo de Facilitador",'required|xss_clean');
