...
class Pl_modulo_temas extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="pl_modulo_temas";

	public $modelo_usar="pl_modulo_temas_model";

	public $nombre_controlador="pl_modulo_temas";
	
	public $nombre_titulo="Modulos - Temas";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_tema","Tema",'required|xss_clean','text',array());
