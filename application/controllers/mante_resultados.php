...
class Mante_resultados extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_resultados";

	public $modelo_usar="mante_resultados_model";

	public $nombre_controlador="mante_resultados";
	
	public $nombre_titulo="Resultados de Evaluación";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre","Categoria de evaluación",'required|xss_clean', 'text');
