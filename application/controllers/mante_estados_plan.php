...
class Mante_estados_plan extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_estados_plan";

	public $modelo_usar="mante_estados_plan_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_estado","Nombre",'required|xss_clean');
