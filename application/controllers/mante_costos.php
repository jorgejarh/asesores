...
class Mante_costos extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_costos";

	public $modelo_usar="mante_costos_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_costo","Nombre",'required|xss_clean');
