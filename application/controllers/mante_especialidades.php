...
class Mante_especialidades extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_especialidades";

	public $modelo_usar="mante_especialidades_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_especialidad","Especialidad",'required|xss_clean');
