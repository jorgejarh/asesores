...
class Ofertas_estados extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="ofertas_estados";

	public $modelo_usar="ofertas_estados_model";

	public $nombre_controlador="ofertas_estados";
	
	public $nombre_titulo="Ofertas - Estados";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre","Estado",'required|xss_clean', 'text');
