...
class Ofertas_resoluciones extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="ofertas_resoluciones";

	public $modelo_usar="ofertas_resoluciones_model";

	public $nombre_controlador="ofertas_resoluciones";
	
	public $nombre_titulo="Ofertas - Resoluciones";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre","Resolucion",'required|xss_clean', 'text');
