...
class Mante_tipos_provee extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_tipos_provee";

	public $modelo_usar="mante_tipos_provee_model";

	public $nombre_controlador="mante_tipos_provee";
	
	public $nombre_titulo="Tipos de Proveedores";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_tipo","Nombre",'required|xss_clean');
