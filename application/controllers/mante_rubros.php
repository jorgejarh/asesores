...
class Mante_rubros extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_rubros";

	public $modelo_usar="mante_rubros_model";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre","Nombre",'required|xss_clean', 'text');
