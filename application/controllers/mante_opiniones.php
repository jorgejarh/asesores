...
class Mante_opiniones extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_opiniones";

	public $modelo_usar="mante_opiniones_model";

	public $nombre_controlador="mante_opiniones";
	
	public $nombre_titulo="Opiniones";
	...
	function __construct()
    {
		...
		$this->set_campo("nombre_opinion","Opinion",'required|xss_clean', 'textarea');
