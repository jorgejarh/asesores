...
class Ase_bitacora extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="ase_bitacora";

	public $modelo_usar="ase_bitacora_model";

	public $nombre_controlador="ase_bitacora";
	
	public $nombre_titulo="Bitacora ";
	...
	function __construct()
    {
		...
		$this->set_campo("observaciones","Observaciones",'required|xss_clean','textarea');
		$this->set_campo("fecha_inicio","Fecha_inicio",'required|xss_clean','text',array(),'fecha__');
		$this->set_campo("fecha_fin","Fecha_fin",'required|xss_clean','text',array(),'fecha__');
	...
	public function index($id=0)
	{
		...
		{
			$model=$this->modelo_usar;
			$data['title']=$this->nombre_titulo."de ".$data['dato']['nombre_actividad'];
