...
class Mante_provee_ser extends CI_Controller {

	public $datos_user=array();

	public $carpeta_view="mante_provee_ser";

	public $modelo_usar="mante_provee_ser_model";

	public $nombre_controlador="mante_provee_ser";
	
	public $nombre_titulo="Proveedores de Servicio";
	...
	function __construct()
    {
		...
		$this->load->model('mante_tipos_provee_model');
		$this->set_campo("id_tipo_proveedor","Tipo de proveedor",'required|xss_clean', 'select',preparar_select($this->mante_tipos_provee_model->obtener(),'id_tipo_proveedor','nombre_tipo'));
		$this->set_campo("nombre_proveedor","Nombre",'required|xss_clean', 'text');
