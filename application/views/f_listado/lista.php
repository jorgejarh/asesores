...
$(document).ready(function(e) {
	...
	$('#id_plan').change(function(e) {
        $.ajax({
			url:"<?php echo site_url('f_listado/obtener_modalidades');?>",
			type:"POST",
	...
	$('#id_plan_modalidad').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('f_listado/obtener_capacitaciones');?>",
			type:"POST",
	...
	$('#id_capacitacion').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('f_listado/obtener_modulos');?>",
			type:"POST",
...
{
	window.location="<?php echo site_url('f_listado/listado');?>/"+$('#id_modulo').val();
}
