...
$(document).ready(function(e) {
	...
	$('#id_plan').change(function(e) {
        $.ajax({
			url:"<?php echo site_url('inscripcion/obtener_modalidades');?>",
			type:"POST",
	...
	$('#id_plan_modalidad').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('inscripcion/obtener_capacitaciones');?>",
			type:"POST",
	...
	$('#id_capacitacion').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('inscripcion/obtener_modulos');?>",
			type:"POST",
...
{
	window.location="<?php echo site_url('inscripcion/inscribir_modulo');?>/"+$('#id_modulo').val();
}
