<div id="content_main" class="clearfix">
  <div id="main_panel_container" class="left">
    <div id="dashboard">
      <h2 class="ico_mug">Sucursales</h2>
      <div class="clearfix">
  ...
  <table id="example" class="display" >
    ...
    <tbody>
      ...
      <tr class="gradeA">
        ...
        <td align="center"><a onClick="editar_registro(<?php echo $valor['id_sucursal']; ?>);"><?php echo img('public/img/edit.png');?></a></td>
        <td align="center"><a onClick="eliminar_registro(<?php echo $valor['id_sucursal']; ?>);" ><?php echo img('public/img/cancel.png');?></a></td>
      </tr>
      <?php
		}
		?>
