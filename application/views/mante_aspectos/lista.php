      ...
      <h2 class="ico_mug">
      	<table style="width:100%;">
      		<tr>
      			...
      			<td style="text-align:right;"><button onClick="nuevo_registro(<?php echo $categoria['id_mante_cat_resultado'];?>);">Nuevo</button></td>
      		</tr>
      	</table>
      </h2>
       <div class="bot_atras">
    	<?php
        echo anchor('mante_resultados','<- Regresar');
		?>
    </div>
    ...
    <tbody>
      <?php
		foreach($listado as $valor)
		{
			?>
      <tr class="gradeA">
      	<td><?php echo $valor['id_aspectos_considerar'];?></td>
