...
<div style="width:900px; margin:auto;" align="center">
  <div style="position:relative; " align="right">
    <div class="div_imprimir"><?php echo img(array('src'=>'public/img/icono-impresora.jpg','width'=>50));?> 
      <ul class="opciones_">
        <li><a href="<?php echo site_url('temas_disponibles/index/web');?>" target="_blank">Desde la web</a></li>
        <!--<li><a href="<?php echo site_url('temas_disponibles/index/excel');?>" target="_blank">Exportar a Excel</a></li>-->
      </ul> 
    </div>
  </div>
  <?php
