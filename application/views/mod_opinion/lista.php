...
$(document).ready(function(e) {
	...
	$('#id_plan').change(function(e) {
        $.ajax({
			url:"<?php echo site_url('mod_opinion/obtener_modalidades');?>",
			type:"POST",
	...
	$('#id_plan_modalidad').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('mod_opinion/obtener_capacitaciones');?>",
			type:"POST",
	...
	$('#id_capacitacion').live('change',function(e) {
        $.ajax({
			url:"<?php echo site_url('mod_opinion/obtener_modulos');?>",
			type:"POST",
...
{
	window.location="<?php echo site_url('opinion/index');?>/"+$('#id_modulo').val();
}
