...
<div style="width:900px; margin:auto;" align="center">
  <div style="position:relative; " align="right">
    <div class="div_imprimir"><?php echo img(array('src'=>'public/img/icono-impresora.jpg','width'=>50));?> 
      <ul class="opciones_">
        <li ><a href="<?php echo site_url('pl_modulos/ver_presupuesto/'.$datos['id_plan']."/web");?>" target="_blank">Desde la web</a></li>
        <!--<li><a  href="<?php echo site_url('pl_modulos/ver_presupuesto/'.$datos['id_plan']."/pdf");?>" target="_blank">Exportar a pdf</a></li>-->
        <li><a href="<?php echo site_url('pl_modulos/ver_presupuesto/'.$datos['id_plan']."/excel");?>" target="_blank">Exportar a Excel</a></li>
      </ul> 
    </div>
  </div>
