...
<title><?php echo $title;?></title>
	...
	<!--[if IE]><link rel="stylesheet" href="<?php echo base_url();?>public/css/ie.css" type="text/css" media="screen, projection" /><![endif]-->
	...
	<script type="text/javascript" src="<?php echo base_url();?>public/js/custom.js"></script>
	 ...
	 <!--[if IE]><script language="javascript" type="text/javascript" src="<?php echo base_url();?>public/excanvas.pack.js"></script><![endif]-->
</head>
<body>