...
if($listado)
{
	?>
        <table id="example" class="display" >
          <thead>
            <tr>
              <th>Id</th>
              <th>Fecha</th>
              <th>Nombre Recomendación</th>
              <th>Descripcion de Recomendación</th>
              <th>&nbsp;</th>
              <th>&nbsp;</th>
            </tr>
          </thead>
		...
		foreach($listado as $valor)
		{
			...
			?>
            <tr class="gradeA">
              <td><?php echo $valor['id_recomendacion'];?></td>
              <td><?php echo date('d/m/Y',strtotime($valor['fecha_recomendacion']));?></td>
              <td><?php echo $valor['nombre_recomendacion'];?></td>
              <td><?php echo $valor['descripcion_recomendacion'];?></td>
